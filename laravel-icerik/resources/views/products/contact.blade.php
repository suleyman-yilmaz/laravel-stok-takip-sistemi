...
<div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body text-center"> <!-- text-center ile içeriği ortala -->
                    ...
                    <div class="col-lg-8 mx-auto mt-4"> <!-- mx-auto ile yatayda ortala -->
                                    ...
                                    <div class="d-flex flex-sm-row flex-column gap-sm-7 gap-3">
                                        <div class="d-flex flex-column flex-grow-1 gap-2">
                                            ...
                                            <input type="phone" name="phone" id="phone"
                                                placeholder="000 000 00 00" class="form-control" required>
                                        </div>
                                        <div class="d-flex flex-column flex-grow-1 gap-2">
