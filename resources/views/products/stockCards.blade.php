                ...
                <div class="container-fluid" style="background-color: white; border-radius: 30px;">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <!-- Offcanvas -->
                            <div class="offcanvas offcanvas-end" tabindex="-1" id="addStockCardCanvas"
                                 aria-labelledby="addStockCardCanvasLabel">
                                <div class="offcanvas-header">
                                    <h5 id="addStockCardCanvasLabel">Stok Kartı Oluştur</h5>
                                ...
                                <div class="offcanvas-body">
                                    ...
                                    <form action="{{ route('stock.cards.store') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            <label for="unit" class="form-label">Birimi</label>
                                            <input type="text" class="form-control" id="unit" name="unit" required>
                                        </div>
                                        <button type="submit" class="btn btn-primary">Stok Kartı Oluştur</button>
                                    </form>
                                </div>
                            </div>
                                    ...
                                    <div class="card">
                                        <div class="d-flex justify-content-end mb-3">
                                            <button class="btn btn-success" type="button" data-bs-toggle="offcanvas"
                                                    data-bs-target="#addStockCardCanvas"
                                                    aria-controls="addStockCardCanvas">
                                                Stok Kartı Ekle
                                            </button>
                                        </div>
